          ...
          <div className="space-y-6">
            <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-100">
              ...
              <p className="text-gray-600">
                Our detection system uses advanced AI models to analyze images
                for signs of synthetic generation. While highly sophisticated,
                no AI detector is 100% accurate. We provide confidence scores
                and explanations to help you make informed decisions.
              </p>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-green-50 to-teal-50 rounded-xl border border-green-100">
              ...
              <p className="text-gray-600">
                We collect anonymous usage data including image metadata
                (dimensions, file size), analysis results, and optional user
                feedback. Your actual image is only stored if you give explicit
                consent for research purposes. We provide a delete code so you
                can remove your data anytime.
              </p>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-100">
              ...
              <p className="text-gray-600">
                We can identify images created by popular AI models like DALL-E,
                Midjourney, Stable Diffusion, and others. We also detect
                deepfakes and face-swapped content.
              </p>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-red-100">
              ...
              <p className="text-gray-600">
                After each analysis, you'll receive a unique delete code. Visit
                our delete page and enter this code to remove all associated
                data. No account or personal information required.
              </p>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl border border-yellow-100">
              ...
              <p className="text-gray-600">
                Please use the feedback buttons below each result. This helps us
                improve our accuracy. AI detection is a tool to assist your
                judgment, not replace it. Consider multiple factors when making
                important decisions.
              </p>
            </div>
          </div>
...
const AnalysisSection = () => {
  ...
  const [consent, setConsent] = useState({
    [CONSENT_TYPES.RESEARCH_TRAINING]: true,
  });
  ...
  const resetAnalysis = () => {
    ...
    setError(null);
    setConsent({ [CONSENT_TYPES.RESEARCH_TRAINING]: true });
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
              Drop your image below and get instant AI detection results with
              confidence scores
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8 animate-slide-up hover:shadow-2xl transition-shadow duration-300">
            {error && (
              <div
                className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl animate-slide-up"
                role="alert"
              >
